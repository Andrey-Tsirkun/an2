...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlString = (function () {
	    ...
	    UrlString.prototype.getUrl = function () {
	        return this.apiUrl + "lat=" + this.lat + "&lon=" + this.lon + "&appid=" + this.apiId;
	    };
	    return UrlString;
	}());
...
/***/ function(module, exports) {
	...
	var Config = (function () {
	    function Config() {
	        this.id = '2db3d261239176a961c5abc853c5b1c7';
	        this.url = 'http://api.openweathermap.org/data/2.5/find?';
	    }
	    return Config;
	}());
